...
На цьому ресурсі викладено модифіковану прошивку INAV 8.0 з деякими корисними змінами.
...
Починаючи з версії 8.0, офіційна прошивка включає режим GPS Fix estimation, що дозволяє повернути літак, вікористовуючи лише компас і барометр (або тільки барометр).
