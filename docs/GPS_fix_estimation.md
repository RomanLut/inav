...
*Польотники на **F411** не підтримуються офіційною прошивкою INav 8. Тут викладено також прошивки, зібрані під **F411**. Але працездатність їх не гарантується.*
...
Елементи OSD **GPS Satellites**, **Longitude** та **Latitude**, **MSL Altitude** відображають координати, що використовуються літаком. Це або координати з GPS сенсору (**GPS Satellites** відображає кількість супутників), або естимовані координати (**GPS Satellites** відображає "**ES**").

Кількість супутників, координати **LAT** та **LON**, **MSL Altitude** отримані з сенсору GPS відображаються в наступному рядку відносно відповідного елементу OSD. Тобто ці елементи OSD потрібно розмістити таким чином, щоб у наступному рядку було вільне місце. 
