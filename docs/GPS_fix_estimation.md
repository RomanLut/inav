...
- **барометр**
- **GPS**
- **компас (обовязково для забезпечення точності навігаці, але є варіанти, див. опис нижче)**
...
***На відміну від версіі 6.0, ця версія включає естимацію не лише при втраті супутників, але й при апаратній проблемі GPS сенсору.***
