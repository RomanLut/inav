...
За номрмальних умов, літак отримує свое положення від датчика GPS, що надає йому можливість здійснювати навігацію згідно маршруту.
...
Ще одна важлива команда - можливість виконувати місію без сигналу керування:
