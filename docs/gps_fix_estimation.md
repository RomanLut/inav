...
**Не рекомендується використовувати навігацію без компасу окрім випадку включення RTH через декілька секунд після трати GPS Fix.**

Літак має можливість вираховувати напрямок на північ, коли працює GPS. При відключенні GPS, напрямок на північ видає компас. При відсутновсті компасу, напрямок ны північ перераховується, використовуючи останній відомий напрямок та кутову швидкість. Нажаль, похибка накопичується доволі швидко. В реальних умовах, вже через одну хвилину польоту, напрямок може бути спотворений на 45 градусів! 
