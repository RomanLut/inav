...
В версіі 1.1 додано відображення кількості супутників, координат та різниці координат.

Очевидно, що це працює, коли сенсор примусово відлючений за допомогою GPS OFF BOX.
...
*(Якщо помилка різко зросла до декулькох кілометрів - GPS серсор приймає спотворені координати (spoofing))*
