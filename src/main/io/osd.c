 ...
 */
static void osdFormatDistanceSymbol(char *buff, uint32_t dist, uint8_t decimals, uint8_t digits)
{
...
*/
            ...
            if ( gpsSol2.fixType == GPS_FIX_3D ) {
              osdFormatDistanceSymbol(buff + 1, err >= 99900000 ? 99900000 : err, 0, 3);
            }
            else {
            buff[1] = '-';
            buff[2] = '-';
